...
import 'package:calculator_project/colors.dart';
                ...
                children: [
                  Expanded(
                    child: FloatingActionButton(
                      ...
                      child: Text(
                        "1",
                        style: TextStyle(fontSize: 30.0, color: AppColors.purple),
                      ),
                      onPressed: () {
                        setState(() {
                          _store += '1';
                  ...
                  Expanded(
                    child: FloatingActionButton(
                      ...
                      child: Text(
                        "C",
                        style:
                        TextStyle(fontSize: 30.0, color: AppColors.redAccent),
                      ),
                      onPressed: () {
                        setState(() {
                          _store = " ";
                ...
                children: [
                  ...
                  Expanded(
                    child: FloatingActionButton(
                      ...
                      child: Text(
                        ".",
                        style: TextStyle(fontSize: 30.0, color: AppColors.blue),
                      ),
                      onPressed: () {
                        setState(() {
                          _store += '.';
                ...
                children: [
                  ...
                  Expanded(
                    child: FloatingActionButton(
                      ...
                      child: Text(
                        "=",
                        style: TextStyle(fontSize: 30.0, color: AppColors.red),
                      ),
                      onPressed: () {
                        setState(() {
                          String evaluated = prediction();
  ...
  Widget showErrorMessage(BuildContext context) {
    AlertDialog alertDialog = AlertDialog(
      ...
      content: Text(
        ...
        style: TextStyle(color: AppColors.yellowAccent, letterSpacing: 1.0),
      ),
